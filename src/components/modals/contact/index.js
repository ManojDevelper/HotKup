...
const ContactModal = (props) => {
    ...
    return (
      ...
      >
        <div id="navcont">
          <Contact setSuccessModal={setSuccessModal} setOpenLoader={setOpenLoader}/>
        </div>
      </Modal>
      <Modal
        centered
        ...
        bodyStyle={{ backgroundColor: `transparent`, height: `0`, padding: `0` }}
        style={{ backgroundColor: `rgb(0 0 0 / 50%)`, height: `0`, padding: `0` }}
        maskStyle={{
